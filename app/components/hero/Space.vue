<template>
  <div class="relative flex flex-1 w-full items-center justify-center overflow-hidden">
    ...
    >
      <svg class="h-full w-full" viewBox="0 0 1834 1080" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g style="mix-blend-mode: plus-lighter" filter="url(#filter2_f_3106_1413)">
          <path
            class="fill-white"
        ...
        <defs>
          <filter
            id="filter0_f_3106_1413" x="0.827881" y="-36.5913" width="3028.72" height="2141.98"
            filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB"
          >
            <feFlood flood-opacity="0" result="BackgroundImageFix" />
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
            <feGaussianBlur stdDeviation="296.204" result="effect1_foregroundBlur_3106_1413" />
          </filter>
          <filter
            id="filter1_f_3106_1413" x="217.812" y="324.363" width="2554.79" height="1668.05"
            filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB"
          >
            <feFlood flood-opacity="0" result="BackgroundImageFix" />
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
            <feGaussianBlur stdDeviation="177.722" result="effect1_foregroundBlur_3106_1413" />
          </filter>
          <filter
            id="filter2_f_3106_1413" x="239.247" y="503.372" width="2592.35" height="1638.62"
            filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB"
          >
            <feFlood flood-opacity="0" result="BackgroundImageFix" />
            <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
    ...
    <div class="relative z-30">
      <div class="flex flex-col items-center justify-center px-4">
        ...
        <h1
          class="via-primary-900/90 to-primary-600/90 dark:via-primary-200/90 dark:to-primary-400/90 font-inter mt-4 bg-gradient-to-br from-dark-950/90 from-55% via-70% to-85% bg-clip-text text-center text-5xl font-bold text-transparent sm:text-6xl lg:text-7xl dark:from-dark-50/90"
        >
